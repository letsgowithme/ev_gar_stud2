 ...
 */
final class Version20231117085420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD CONSTRAINT FK_4C62E6381822F8F0 FOREIGN KEY (car_post_id) REFERENCES car (id)');
