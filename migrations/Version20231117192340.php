 ...
 */
final class Version20231117192340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, images_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, year INT NOT NULL, km INT NOT NULL, fuel_type VARCHAR(255) NOT NULL, price INT NOT NULL, color VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', length INT DEFAULT NULL, width INT DEFAULT NULL, height INT DEFAULT NULL, weight INT DEFAULT NULL, price_min INT DEFAULT NULL, price_max INT DEFAULT NULL, INDEX IDX_773DE69DF675F31B (author_id), INDEX IDX_773DE69DD44F05E5 (images_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE car ADD CONSTRAINT FK_773DE69DD44F05E5 FOREIGN KEY (images_id) REFERENCES images (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car DROP FOREIGN KEY FK_773DE69DD44F05E5');
